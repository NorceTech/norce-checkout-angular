...
export class DataService {
  ...
  createShipping(orderId: string): Observable<any> {
    return this.client.post<any>(`${this.baseUrl}/orders/${orderId}/shippings`, undefined)
  }

  getShipping(orderId: string, paymentId: string): Observable<any> {
    return this.client.get<any>(`${this.baseUrl}/orders/${orderId}/shippings/${paymentId}`)
  }

  removeShipping(orderId: string, shippingId: string): Observable<void> {
    return this.client.post<void>(`${this.baseUrl}/orders/${orderId}/shippings/${shippingId}/remove`, undefined)
  }
